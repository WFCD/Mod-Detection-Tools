...
[![CI](https://github.com/WFCD/Mod-Detection-Tools/actions/workflows/ci.yml/badge.svg)](https://github.com/WFCD/Mod-Detection-Tools/actions/workflows/ci.yml)
...
## Requirements
- Java 16 or higher
- Private Access Token with `read:packages` in maven settings.xml. [See here](https://docs.github.com/en/packages/working-with-a-github-packages-registry/working-with-the-apache-maven-registry#authenticating-with-a-personal-access-token) for instructions
