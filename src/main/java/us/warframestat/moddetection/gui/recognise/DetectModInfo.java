...
public class DetectModInfo {
  ...
  private static final List<String> rivenNames =
      Arrays.asList(
          "Ampi", "Manti", "Argi", "Pura", "Geli", "Tori", "Uti", "Tempi", "Crita", "Pleci", "Acri",
          "Visi", "Vexi", "Igni", "Exi", "Croni", "Conci", "Magna", "Arma", "Sati", "Toxi", "Lexi",
          "Insi", "Feva", "Locti", "Sci", "Hexa", "Deci", "Zeti", "Hera");
